// Version: 4.0.0 - Pickaxe Overhaul & Auto Trash
const TOOTH_DATA = {
    icons: ["🦷", "🦴", "💎", "✨", "🔥", "🧊", "⚡", "🌈", "🔱", "🌑", "☀️", "🔮", "🧿", "💠", "🏵️", "🍀", "🍃", "🎃", "🥊", "⚔️", "🏹", "🛡️", "🧬", "🧪", "🦾", "📡", "🛸", "🪐", "🌟", "🌌", "🌋", "🐲", "👾", "🤖", "🤡", "👹", "👑", "💎", "🦷", "💠"],
    // 곡괭이 밸런스 개편: baseLv 삭제 -> luck(상위), double(2개), great(합성대성공) 확률로 변경
    pickaxes: [
        { name: "허름한 나무 곡괭이", cost: 0, luck: 0, double: 0, great: 0, icon: "🪵" },
        { name: "무딘 구리 곡괭이", cost: 500, luck: 0.05, double: 0, great: 0.025, icon: "🪨" },
        { name: "튼튼한 철 곡괭이", cost: 2500, luck: 0.10, double: 0, great: 0.05, icon: "⛏️" },
        { name: "연마된 강철 곡괭이", cost: 15000, luck: 0.15, double: 0.05, great: 0.075, icon: "⚔️" },
        { name: "빛나는 황금 곡괭이", cost: 100000, luck: 0.20, double: 0.10, great: 0.10, icon: "⚜️" },
        { name: "고강도 티타늄 곡괭이", cost: 800000, luck: 0.25, double: 0.15, great: 0.125, icon: "💠" },
        { name: "영롱한 다이아 곡괭이", cost: 5000000, luck: 0.30, double: 0.20, great: 0.15, icon: "💎" },
        { name: "카본 초합금 곡괭이", cost: 50000000, luck: 0.40, double: 0.30, great: 0.20, icon: "🔮" },
        { name: "신화의 오리할콘 곡괭이", cost: 1000000000, luck: 0.50, double: 0.40, great: 0.25, icon: "👑" }
    ],
    mercenaries: [
